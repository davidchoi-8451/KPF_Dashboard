...
- KPF dashboard encompasses uplift and engagement metric at a holistic level by tactic and by Open/Closed Loop, as well as by Audience Segment, Card Partner, and more. This also takes into account exceptions in certain campaigns, such as $ off offers (sourced directly from MHTV), no offer attached, and one-off campaigns. Any campaign delays are highlighted in Campaign Availability tab, and iService tickets are automated by WNs with an expected turnaround of ~2-3 weeks.
